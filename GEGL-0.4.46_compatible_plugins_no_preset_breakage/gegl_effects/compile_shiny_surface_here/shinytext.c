 ...
 * GEGL Shiny Text for Graphical Effects CE- Beaver 2023
 */

/*Shiny Text is a hidden operations for Graphical Effects. It is literally just gegl:sinus done in a special setting with a disable checkbox.
 The goal is to eventually bake it inside Graphical Effects and get rid of this hidden operation. */
...
property_boolean (enable, _("Enable Shine for Graphical Effects"), FALSE)
...
GeglOperationMetaClass *operation_meta_class = GEGL_OPERATION_META_CLASS (klass);
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "description", _("Render a shiny effect on text. This won't work on normal images. Only Text! Users are specified to use Gimp/GEGL blend modes and opacity slider with this"),
    NULL);
}
