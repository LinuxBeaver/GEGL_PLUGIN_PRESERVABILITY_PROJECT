 ...
 * 2023 Beaver (GEGL ZZStrokeBevelImageOverlay a hidden operation fork of drop shadow to give Graphical Effects outline the ability to add a bevel, image file overlay and more. May 16 23 it now gives Graphical Effects drop shadow a blurred image file overlay. May 17 2023 it now has an aura seed option for shadow glow )
 */

/*zzstrokebevelimage is a hidden operations for Graphical Effects. The goal is to eventually bake it inside Graphical Effects and get rid of this hidden operation. 
This hidden operation is meant to be a better drop shadow. Before it existed Graphical Effects called Gimp's normal drop shadow filter*/
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "title",       _("Hidden Operation to bevel and image file overlay a stroke for Graphical Effects. Graphical Effects will not work at all without this hidden operation."),
    "categories",  "hidden",
    "reference-hash", "33234v25str2ac",
    "description", _("Hidden Operation for Graphical Effects - This is a rough reimagination of Gimp's drop shadow filter with many new things and technical options that drop shadow was not capable of doing. Graphical Effects no longer calls Gimp's GEGL drop shadow filter. It uses this under the hood."
                     ""),
    NULL);
}
